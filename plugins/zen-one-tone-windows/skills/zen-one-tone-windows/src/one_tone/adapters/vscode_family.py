...
def build_theme_json(plan: Plan, theme_name: str, mode: str | None = None) -> dict[str, Any]:
    ...
    sidebar_surface = palette["surface"] if mode == "light" else palette["surface_subtle"]
    light_mode_foreground = palette["foreground"] if mode == "light" else background_foreground
    return {
        "name": theme_name,
        "type": mode,
        "colors": {
            ...
            "editorGroupHeader.tabsBackground": sidebar_surface,
            ...
            "sideBarSectionHeader.background": light_mode_surface,
            "sideBarSectionHeader.foreground": light_mode_foreground,
            "sideBarSectionHeader.border": palette["border"],
            "activityBar.background": light_mode_surface,
            "activityBar.foreground": light_mode_foreground,
            ...
            "activityBarTop.background": light_mode_surface,
            "activityBarTop.foreground": light_mode_foreground,
            ...
            "titleBar.inactiveBackground": light_mode_surface,
            "titleBar.inactiveForeground": light_mode_foreground,
            "titleBar.border": palette["border"],
            "tab.activeBackground": palette["surface"],
            "tab.activeForeground": palette["foreground"],
            "tab.inactiveBackground": light_mode_surface,
            "tab.inactiveForeground": light_mode_foreground,
            "tab.activeBorderTop": palette["accent"],
            "panel.background": light_mode_surface,
            "panel.foreground": light_mode_foreground,
            "panel.border": palette["border"],
            "panelTitle.activeBorder": palette["accent"],
            "panelTitle.activeForeground": light_mode_foreground,
            ...
            "input.foreground": light_mode_foreground,
            ...
            "dropdown.foreground": light_mode_foreground,
            ...
            "notificationCenterHeader.foreground": light_mode_foreground,
            ...
            "breadcrumb.background": light_mode_surface,
            "breadcrumb.foreground": light_mode_foreground,
