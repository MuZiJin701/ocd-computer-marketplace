...
3. Map inline and list prediction text to the secondary text role after actual-background validation, and map selected prediction to the existing selection foreground/background pair. Do not change prediction sources or key bindings.
